...
import { soundCloudSongOfSolomon } from '../../services/soundcloud';
      ...
      <div className="Home">
        ...
        <div className="text">
          ...
          <ReactCSSTransitionGroup {...slideUpTransitionOptions}>
            <div className="title">Song Of Solomon</div>
            <div className="callToAction">
              <ReactGA.OutboundLink
                eventLabel="soundCloudSongOfSolomon"
                to={soundCloudSongOfSolomon}>
